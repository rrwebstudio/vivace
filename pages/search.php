        ...
        // Page for viewing a tag
            ...
            if(!empty($_SESSION['user_id'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $event_cat_key = (is_numeric($_SESSION['event_cat_key']) ? $_SESSION['event_cat_key'] : null);
                    $event_type_key = (is_numeric($_SESSION['event_type_key']) ? $_SESSION['event_type_key'] : null);
                    $venue_cat_key = (is_numeric($_SESSION['venue_cat_key']) ? $_SESSION['venue_cat_key'] : null);
                    $venue_type_key =(is_numeric($_SESSION['venue_type_key']) ? $_SESSION['venue_type_key'] : null);
                    $price_range_key = (is_numeric($_SESSION['price_range_key']) ? $_SESSION['price_range_key'] : null);
                }                
                ...
                if($selected_event_cat && $selected_event_type && $selected_venue_cat && $selected_venue_type){
                    ...
                    if(is_numeric($_SESSION['event_cat_key'])) {
                        $_SESSION['event_cat_key'] = '';
                    }
                    if (is_numeric($_SESSION['event_type_key'])) {
                        $_SESSION['event_type_key'] = '';
                    }
                    if(is_numeric($_SESSION['venue_cat_key'])){
                        $_SESSION['venue_cat_key'] = '';
                    }
                    if(is_numeric($_SESSION['venue_type_key'])){
                        $_SESSION['venue_type_key'] = '';
                    }
                    if(is_numeric($_SESSION['price_range_key'])) {
